...
# ============================================================================
BOT_TOKEN = os.environ.get('BOT_TOKEN', '8635214594:AAFTpbdTopE-gR8w3gvgnfv8IJwzN5x_i_k')  # MAIN BOT ТОКЕН
...
# ============================================================================
HEADLESS = True
MAX_WORKERS = 11 # количество параллельных вкладок в одном браузере
